...
const GameEntry kGames[] = {
    ...
    {49, "穿墙蛇", "WarpSnack", GameStatus::Implemented, 80, 30},
    {50, "双人蛇", nullptr, GameStatus::Unimplemented, 0, 0},
    {51, "障碍蛇", "ObstacleSnack", GameStatus::Implemented, 80, 30},
    {52, "限时蛇", "TimedSnack", GameStatus::Implemented, 80, 30},
    {53, "加速蛇", "SpeedSnack", GameStatus::Implemented, 80, 30},
    {54, "围墙蛇", "WallSnack", GameStatus::Implemented, 80, 30},
